  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        console.log("imageName field:", response.data.imageData);
        if (response.data.imageData) {
          console.log("Fetching image...");
          fetchImage();
        } else {
          console.log("No imageName field - skipping image fetch");
        }
      } catch (error) {
    ...
    <div className="container mt-5 pt-5">
      <div className="row">
        ...
        <div className="col-md-6">
          ...
          <h2 className="text-capitalize mb-1">{product.productName}</h2>
          ...
          {/* ✅ 2. MODIFIED: Flex container for Cart + Wishlist buttons */}
          <div className="d-flex gap-3 mb-4 align-items-center">
            <button
              className="btn btn-primary btn-lg flex-grow-1" // flex-grow makes it take available space
