          ...
          <div className="toast-body">
            {toastProduct && (
              <div className="d-flex align-items-center">
                ...
                />
                <div>
                  <div className="fw-bold">{toastProduct.productName}</div>
        ...
        <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
          {!filteredProducts || filteredProducts.length === 0 ? (
            ...
            filteredProducts.map((product) => {
              const { id, brand, productName, price, productAvailable, productImage, imageData, stockQuantity } = product;
                  ...
                  <div className={`card h-100 shadow-sm ${!productAvailable ? 'opacity-75' : ''}`}>
                    <Link to={`/product/${id}`} className="text-decoration-none text-dark">
                      ...
                      <div className="card-body d-flex flex-column">
                        <h5 className="card-title">{productName?.toUpperCase() || 'N/A'}</h5>
